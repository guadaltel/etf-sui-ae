...
public class LegendURL{
	...
	public LegendURL(XmlHolder xml) {
		width = Long.valueOf(xml.getNodeValue("/*:LegendURL@width"));
		height = Long.valueOf(xml.getNodeValue("/*:LegendURL@height"));
		format = xml.getNodeValue("/*:Format");
		onlineResource = xml.getNodeValue("/*:OnlineResource@href");
	}
